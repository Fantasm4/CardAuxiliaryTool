...
/*
*@ All rights reserved for inacho from this class.
*/
...
class CreditCard
{
    protected static $cards = array(
        ...
        'hipercard' => array(
            'type' => 'hipercard',
            //'pattern' => '/^(606282\d{10}(\d{3})?)|(3841\d{15})$/', Pattern Antiga..
    ...
    public static function validBander($lista)
    {
        $v = substr($lista, 0,1);
        if($v == 4){return 'v';}
        if($v == 5){return 'm';}
